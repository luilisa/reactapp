...
class UpdateCompanyComponent extends Component {
    ...
    componentDidMount() {
        CompanyService.getCompanyById(this.state.id).then((response) => {
            ...
            this.setState({name: company.name, symbol: company.symbol, sector:company.sector,
                marketCap: company.marketCap, ipoYear: company.ipoYear, country:company.country});
        });
    }
    ...
    updateCompany = (e) => {
        ...
        CompanyService.updateCompany(company, this.state.id).then((response) => {
                        ...
                        <div className='card w-50 offset-md-3 offset-md-3'>
                            ...
                            <div className='card-body' >
                                ...
                                <div className='form-group'>
                                    ...
                                    <button className='btn btn-success' onClick={this.updateCompany}>Confirm </button>
...
export default withParams(UpdateCompanyComponent);